...
class _TagEditorScreenState extends State<TagEditorScreen> {
      ...
      appBar: AppBar(
        ...
        actions: [
          if (_isSaving)
            ...
            TextButton(
              onPressed: _saveTags,
              child: const Text('SAVE', style: TextStyle(color: AppColors.accentOrange, fontWeight: FontWeight.bold)),
            ),
        ],
      ),
  ...
  Widget _buildTextField(String label, TextEditingController controller, {TextInputType? keyboardType}) {
    return Column(
      ...
      children: [
        Text(label, style: AppTextStyles.bodySmall.copyWith(color: AppColors.accentOrange)),
        TextField(
          ...
          decoration: const InputDecoration(
            ...
            focusedBorder: UnderlineInputBorder(borderSide: BorderSide(color: AppColors.accentOrange)),
          ),
        ),
      ],
    );
